...
export default all([takeLatest(DimensionsTypeKeys.GET_DIMENSIONS_REQUEST, getDimensions), takeLatest(DimensionsTypeKeys.CREATE_DIMENSIONS_REQUEST, createDimension)]);
