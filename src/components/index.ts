...
export { default as EditQuestions } from './pages/Questions/EditQuestions.page'
...
export { default as ForgotPassword } from './pages/ForgotPassword/ForgotPassword.page'
...
export { default as LoggedOutTemplate } from './templates/LoggedOut/LoggedOut'